		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active"
					style="background-image: url('img/테스트배경1.jpg')">
					<div class="carousel-caption d-none d-md-block">
						<h2 class="display-4">테스트 제목1</h2>
						<p class="lead">테스트 내용1</p>
					</div>
				</div>
				<!-- Slide Two - Set the background image for this slide in the line below -->
				<div class="carousel-item"
					style="background-image: url('img/테스트배경2.jpg')">
					<div class="carousel-caption d-none d-md-block">
						<h2 class="display-4">테스트 제목2</h2>
						<p class="lead">테스트 제목2</p>
					</div>
				</div>
				<!-- Slide Three - Set the background image for this slide in the line below -->
				<div class="carousel-item"
					style="background-image: url('img/테스트배경3.jpg')">
					<div class="carousel-caption d-none d-md-block">
						<h2 class="display-4">테스트 제목3</h2>
						<p class="lead">테스트 제목3</p>
					</div>
				</div>
			</div>
